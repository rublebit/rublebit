...
#ifndef H_RUBLEBIT_SCRIPT
#define H_RUBLEBIT_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CRubleBitAddress
 */
...
public:
    ...
    // Pre-version-0.6, RubleBit always counted CHECKMULTISIGs
