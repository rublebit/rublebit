...
#ifndef _RUBLEBITRPC_H_
#define _RUBLEBITRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // RubleBit is not connected
...
/**
 * RubleBit RPC command dispatcher.
 */
class CRPCTable
{
private:
