    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new RubleBitUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->rublebitAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting RubleBit."), QMessageBox::Ok);
