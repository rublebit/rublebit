...
unlocked to sign the RubleBit-Qt.app bundle.
...
allowing somebody to distribute a RubleBit-Qt.app or rublebit-qt-setup.exe with a valid
...
that the rublebit-qt.exe file inside the installer had not been tampered with.
