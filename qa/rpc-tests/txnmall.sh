...
echo "Done, rublebitd's shut down. To rerun/poke around:"
echo "${1}/rublebitd -datadir=$D1 -daemon"
echo "${1}/rublebitd -datadir=$D2 -daemon -connect=127.0.0.1:11000"
echo "To cleanup:"
echo "killall rublebitd; rm -rf test.*"
exit 0
